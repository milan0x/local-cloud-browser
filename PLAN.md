...
- [x] Default connection profile named "default connection" — concise lowercase label. Connection name font in sidebar bottom bar set to `.callout` for readability.
